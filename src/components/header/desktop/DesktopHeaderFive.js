...
import CompareIcon from "@public/assets/images/svg/compare.svg";
import WishlistIcon from "@public/assets/images/svg/wishlist.svg";

const logo = "/assets/images/no-placeholder/logo.png";

const DesktopHeaderFive = ({navbarAlignment, logoAlignment, containerFluid}) => {
                ...
                <Row>
                    <Col lg={3}>
                        <div className="tt-col-obj tt-obj-menu-categories tt-desktop-parent-menu-categories">
                            <CategoriesMenu className="tt-categories-size-large tt-categories-btn-full-width categories-btn-noclick"/>
                        </div>
                    </Col>
                    <Col lg={9}>
