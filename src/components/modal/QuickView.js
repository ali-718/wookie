                                ...
                                {variations ? (
                                    ...
                                    <div className="tt-swatches-container">
                                        <div className="tt-wrapper">
                                            <div className="tt-title-options">
                                                COLOR: <span
                                                className="current_option_name">{toCapitalize(productColor)}</span>
                                            </div>

                                            <div className="tt-title-options mt-2">
                                                SIZE: <span
                                                className="current_option_name">{productSize.toUpperCase()}</span>
                                            </div>

                                            <div className="tt-title-options mt-2">
                                                MATERIAL: <span
                                                className="current_option_name">{toCapitalize(productMaterial)}</span>
                                            </div>
                                        </div>
                                    </div>
                                )}
