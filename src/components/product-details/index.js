...
import ProductDetailsThumbnail from "./Thumbnail";
...
import {getCartProduct, getCartProductQuantity, getDiscountPrice, getWishCompareProduct} from "@utils/product";
                                        ...
                                        <div className="tt-wrapper">
                                            <div className="tt-title-options">
                                                ...
                                                <span className="current_option_name">
                                                    {toCapitalize(productColor)}
                                                </span>
                                            </div>

                                            <div className="tt-title-options mt-2">
                                                SIZE:
                                                <span className="current_option_name">{productSize.toUpperCase()}</span>
                                            </div>
                                                    ...
                                                    <table className="tt-table-03">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td>
                                                                ...
                                                                )) : <span>{product.color.name.toUpperCase()}</span>}
                                                            </td>
                                                        </tr>
                                                        <tr>
                                                            <td>Sizes:</td>
